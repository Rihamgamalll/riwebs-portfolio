...
export const projects: Project[] = [
  {
    ...
    number: '01',
    name: 'RiWebs',
    image: '/images/projects/riwebs.png',
    url: 'https://riwebs.vercel.app/',
    categories: ['Brand', 'Creative', 'Interactive'],
    tone: 'violet',
    type: {
      en: 'Official RiWebs Website / Brand Concept',
      ar: 'الموقع الرسمي لـ RiWebs / تجربة البراند'
    },
    description: {
  ...
  },
  {
    ...
    number: '02',
    name: 'NØIR BEAN',
    image: '/images/projects/noir-bean.png',
    url: 'https://noir-bean-three.vercel.app/',
    categories: ['Business', 'Restaurant', 'Creative'],
    tone: 'coffee',
    type: {
      en: 'Café Concept / Sensory Web Experience',
      ar: 'تجربة Café تفاعلية وحسية'
    },
    description: {
  ...
  },
  {
    ...
    number: '03',
    name: 'LUMA',
    image: '/images/projects/luma.png',
    url: 'https://luma-scarves.vercel.app/',
    categories: ['Brand', 'Fashion', 'Creative'],
    tone: 'sand',
    type: {
      en: 'Scarf / Hijab Brand Website Concept',
      ar: 'تجربة براند طرح وحجاب'
    },
    description: {
  ...
  },
  {
    id: 'restaurant',
    number: '04',
    name: 'RIWEBS RESTAURANT',
    image: '/images/projects/restaurant.png',
    url: 'https://riwebs-restaurant.vercel.app/',
    categories: ['Business', 'Restaurant', 'Interactive'],
    tone: 'ember',
    type: {
      en: 'Restaurant Website Concept',
      ar: 'تجربة موقع مطعم'
    },
    description: {
  ...
  },
  {
    id: 'sanooa',
    number: '05',
    name: 'SANOOA GRADUATION',
    image: '/images/projects/sanooa.png',
    url: 'https://sanoaa.vercel.app/',
    categories: ['Personal', 'Celebration', 'Creative'],
    tone: 'blush',
    type: {
      en: 'Graduation / Personal Celebration Experience',
      ar: 'تجربة احتفال تخرج شخصية'
    },
    description: {
  ...
  },
  {
    ...
    number: '06',
    name: 'MARIAM HESHAM',
    image: '/images/projects/mariam.png',
    url: 'https://mariam-hesham.vercel.app/',
    categories: ['Personal', 'Surprise', 'Creative'],
    tone: 'rose',
    type: {
      en: 'Surprise Personal Website / Gift Link',
      ar: 'موقع شخصي مفاجأة / Gift Link'
    },
    description: {
